...
## v0.51 배포 주의
전체 파일(루트의 index.html, sw.js, js/, css/, images/, audio/)을 한 번에 업로드해야 합니다. index.html만 따로 올리거나 js/app.js만 올리면 실행 버전이 섞여 프롤로그/대사가 멈출 수 있습니다. 기존 학생 진행 상태는 로컬 저장소에 유지됩니다.
