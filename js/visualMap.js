...
window.SPECIAL_CUE_MAP = {'scene-02:6':{key:'young_louis_fronde',hold:1450},'scene-06:0':{key:'louis_wakes_as_anne',hold:2200,minHold:850,interactive:true},'scene-09:12':{key:'summon_parliament_event',hold:1800},'scene-20:4':{key:'charles_door_flash',hold:1800},'scene-28:2':{key:'dream_crown_offer',hold:2400,minHold:900,interactive:true,suppressEffect:true},'scene-33:6':{key:'sun_king_outburst',hold:2000,minHold:900,interactive:true},'scene-36:10':{key:'realization_montage',hold:2800,minHold:1050,interactive:true}};
...
(()=>{
  ...
  // The current version label is owned by index.html / app.js, not old migration scripts.
})();
