// v0.43 original instrumental title theme; other scene tracks remain unassigned.
window.AUDIO_MAP = {
  bgm: {
    TITLE:{path:'audio/title_chamber_theme.mp3',volume:.62}, FRANCE:{path:null,volume:.58}, ENGLAND:{path:null,volume:.55},
