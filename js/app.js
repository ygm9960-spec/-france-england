(()=>{
  ...
  const STORAGE_KEY='sun-king-queen-v0.15';
  const LEGACY_KEYS=['sun-king-queen-v0.14','sun-king-queen-v0.13','sun-king-queen-v0.12','sun-king-queen-v0.11','sun-king-queen-v0.10','sun-king-queen-v0.9','sun-king-queen-v0.8','sun-king-queen-v0.7','sun-king-queen-v0.6','sun-king-queen-v0.5','sun-king-queen-v0.4','sun-king-queen-v0.3','sun-king-queen-v0.2'];
  ...
  const baseState=()=>({
    version:15,started:false,sceneIndex:0,lineIndex:0,usedBullets:[],unlockedConcepts:[],debate:null,history:[],haptics:true,audio:{enabled:true,volume:.58},debateTutorialSeen:false,endingSeen:false
  });
