...
const P = window.DIRECTOR_PRESETS = {
  ...
  lastMirror:{camera:'close',focus:'louis14',pose:'reflective',beatBefore:250,beatAfter:1200}
};
window.DIRECTOR_MAP = {
  ...
  'scene-31:1':{camera:'close',focus:null,beatBefore:80},
  'scene-32:6':{...P.charlesShock},'scene-33:6':{...P.sunClaim},'scene-34:0':{...P.reverse},
